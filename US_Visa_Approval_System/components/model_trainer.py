...
from US_Visa_Approval_System.utils.main_utils import load_numpy_array_data, read_yaml_file, load_object, save_object
from US_Visa_Approval_System.entity.config_entity import ModelTrainerConfig
from US_Visa_Approval_System.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact, ClassificationMetricArtifact
from US_Visa_Approval_System.entity.estimator import USvisaModel
...
class ModelTrainer:
    ...
    def get_model_object_and_report(self, train: np.array, test: np.array) -> Tuple[object, object]:
        ...
        try:
            ...
            model_factory = ModelFactory(model_config_path=self.model_trainer_config.model_config_file_path) # Neuro mf
            ...
            metric_artifact = ClassificationMetricArtifact(f1_score=f1, precision_score=precision, recall_score=recall) # SAving the accuracy score
