...
from US_Visa_Approval_System.constants import APP_HOST, APP_PORT
from US_Visa_Approval_System.pipline.prediction_pipeline import USvisaData, USvisaClassifier
